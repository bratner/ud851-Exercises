...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String toShare= "I am the best of the best of the best!";
    ...
    private void shareText(String in_text)
    {
        String mimeType = "text/plain";
        String title = "Sharing is caring";


        Intent in = ShareCompat.IntentBuilder.from(this)
                .setType(mimeType)
                .setChooserTitle(title)
                .setText(in_text).getIntent();

        if(in.resolveActivity(getPackageManager()) != null)
        {
            startActivity(in);
        } else {
            Log.d("BRAT", "Unable to resolve the intent: "+in.toString());
        }
    }
