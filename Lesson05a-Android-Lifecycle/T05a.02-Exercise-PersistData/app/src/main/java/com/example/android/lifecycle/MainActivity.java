...
public class MainActivity extends AppCompatActivity {
    ...
    private final String LIFECYCLE_CALLBACKS_TEXT_KEY = "mysuperkey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState!=null)
        {
            if(savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
                String prevEvents = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
                mLifecycleDisplay.setText(prevEvents);
            }
        } else {
            Log.d("BRAT", "Nothing was saved.");
        }
