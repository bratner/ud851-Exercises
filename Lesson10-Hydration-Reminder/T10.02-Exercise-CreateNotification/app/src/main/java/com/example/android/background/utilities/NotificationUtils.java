...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENDING_INTENT_CODE = 54745;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "mywaterchannelid";
    private static final int WATER_REMINDER_NOTIFICATION_ID = 1324;
    ...
    public static void remindUsersBecauseCharging(Context context)
    {
        ...
        NotificationCompat.Builder nbuilder = new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
        ...
        nm.notify(WATER_REMINDER_NOTIFICATION_ID, nbuilder.build());
    }
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        PendingIntent ret = PendingIntent.getActivity(context, WATER_REMINDER_PENDING_INTENT_CODE,
    ...
    private static Bitmap largeIcon(Context context) {
        ...
        Bitmap ret = BitmapFactory.decodeResource(resources, R.drawable.ic_local_drink_black_24px);
