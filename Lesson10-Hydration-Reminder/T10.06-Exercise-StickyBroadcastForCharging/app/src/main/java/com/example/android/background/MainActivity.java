...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            IntentFilter stickyFilter = new IntentFilter();
            stickyFilter.addAction(Intent.ACTION_BATTERY_CHANGED);
            Intent batteryStatus = this.registerReceiver(null, stickyFilter);
            int statusInt = batteryStatus.getIntExtra(BatteryManager.EXTRA_STATUS, 0);
            boolean charging = (statusInt & (BatteryManager.BATTERY_PLUGGED_USB
